...
t[#t + 1] =
	Def.Sprite {
		Name="AnimBG";
		Texture=THEME:GetPathG("Title", "BG");
...
t[#t + 1] =
	Def.Quad {
	InitCommand = function(self)
		self:xy(0, 0):halign(0):valign(0):zoomto(250, 900):diffuse(getTitleColor('BG_Left')):diffusealpha(.8)
	end
}
...
t[#t + 1] =
	Def.Quad {
	InitCommand = function(self)
		self:xy(250, 0):halign(0):valign(0):zoomto(1000, 900):diffuse(getTitleColor('BG_Right')):diffusealpha(.8)
	end
}
...
t[#t + 1] =
	Def.Quad {
	InitCommand = function(self)
		self:xy(250, 0):halign(0):valign(0):zoomto(10, 900):diffuse(getTitleColor('Line_Left')):diffusealpha(0)
	end
}
...
t[#t + 1] =
	Def.Quad {
	InitCommand = function(self)
		self:xy(260, 0):halign(0):valign(0):zoomto(10, 900):diffuse(getTitleColor('Line_Right')):diffusealpha(0)
	end
}
...
t[#t + 1] =
	...
	{
		InitCommand=function(self)
			self:xy(100,frameY-82):zoom(1):valign(1):halign(.5):diffuse(getMainColor('positive'))
		end,
		OnCommand=function(self)
			self:settext("StickTrick")
		end
}
